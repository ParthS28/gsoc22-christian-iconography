...
for word in words: 
    embedding_dict.update({
        word: weights[unique_word_dict.get(word)].tolist()
        })
...
os.makedirs(os.path.dirname('output/embeddings.json'), exist_ok=True)
with open('output/embeddings.json', 'w') as fh:
    json.dump(embedding_dict, fh)
...
plt.savefig('output/vectorspace.png')
